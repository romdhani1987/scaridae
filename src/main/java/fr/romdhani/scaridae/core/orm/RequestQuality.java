...
@Entity
@Table(name = "request_quality")
public class RequestQuality implements Serializable {
    ...
    @ManyToMany(mappedBy = "requestQualitySet")
    ...
    public void setResponseQuality(ResponseQuality responseQuality) {
    ...
    public RequestQuality(String name, String description) {
        this.name = name;
        this.description = description;
    }
